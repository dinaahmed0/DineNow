      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-emerald-400">DineNow</h3>
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-emerald-600 hover:bg-emerald-700 w-10 h-10 rounded-full flex items-center justify-center transition-colors">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><a href="components" className="text-gray-300 hover:text-emerald-400 transition-colors">About Us</a></li>
              <li><a href="#" className="text-gray-300 hover:text-emerald-400 transition-colors">How It Works</a></li>
              <li><a href="#" className="text-gray-300 hover:text-emerald-400 transition-colors">Partner Restaurants</a></li>
              <li><a href="#" className="text-gray-300 hover:text-emerald-400 transition-colors">Customer Reviews</a></li>
              <li><a href="#" className="text-gray-300 hover:text-emerald-400 transition-colors">Mobile App</a></li>
              <li><a href="#" className="text-gray-300 hover:text-emerald-400 transition-colors">Gift Cards</a></li>
            </ul>
          </div>

          {/* Support */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-emerald-400">Support</h4>
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-emerald-400 transition-colors">Cancellation Policy</a></li>
          ...
          <div className="space-y-4">
            ...
            {/* Newsletter Signup */}
            <div className="mt-4">
              <h5 className="text-sm font-semibold text-emerald-400 mb-2">Newsletter</h5>
              <div className="flex">
                <input
                  type="email"
                  placeholder="Your email"
                  className="flex-1 px-3 py-2 bg-gray-800 text-white border border-gray-700 rounded-l-lg focus:outline-none focus:border-emerald-400"
                />
