    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="relative bg-white rounded-2xl py-4">
              ...
              <div className="flex items-center p-1">
                <TextInput
                  ...
                  className="flex-1 border-0 focus:ring-0 text-gray-800 placeholder-gray-400 text-lg px-4 pl-11"
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-8">
          <Button
            color={filterType === 'all' ? 'success' : 'light'}
            onClick={() => setFilterType('all')}
            className="flex items-center gap-2"
          >
            <FaInfoCircle />
            All
            <Badge color={filterType === 'all' ? 'success' : 'gray'}>
              {mockSpots.length}
            </Badge>
          </Button>
          <Button
            color={filterType === 'restaurant' ? 'success' : 'light'}
          ...
          <Button
            color={filterType === 'cafe' ? 'success' : 'light'}
        ...
        {(searchTerm || priceFilter !== 'all' || ratingFilter > 0) && (
        ...
        <div className="flex justify-between items-center mb-6">
          <p className="text-gray-500 text-sm">
            Showing <span className="font-semibold text-gray-700">{filteredSpots.length}</span> of{" "}
        ...
        {filteredSpots.length === 0 ? (
          <Card className="text-center py-16">
            ...
            <p className="text-gray-500 text-lg mb-2">No spots found</p>
        ...
        <div className="mt-12 text-center text-sm text-gray-400">
          <p>⭐ Ratings and reviews are based on user feedback • Prices are estimates</p>
        </div>
